<script>
  ...
  const add = async () => {
    ...
    control.loadText = 'Adding channel... Waiting for your wallet confirmation...'
...
<div class="columns is-multiline">
  ...
  <div class="column is-two-thirds">
    <div class="field" >
      ...
      <p class="control">
        <input class="input" type="text" placeholder="Standard Rate, Early Bird, VIP, etc" bind:value={input.label}>
      </p>
  ...
  <div class="column is-one-third">
    <div class="field" >
      <label class="label">Quota/Max supply</label>
      <p class="control">
        <input class="input" type="text" placeholder="default = no limit" bind:value={input.supply}>
      </p>
  ...
  <div class="column is-one-quarter">
    <div class="field">
      ...
      <input id="isFree" type="checkbox" class="switch is-rtl is-outlined" bind:checked={input.free}>
      <label for="isFree" />
    </div>
  </div>
  ...
  <div class="column xis-one-quarter">
    <div class="field" >
      ...
      <p class="control">
        <input class="input" type="text" placeholder="Selling price" bind:value={input.price}>
      </p>
...
<a class="button is-primary" on:click={add}>Add</a>
