...
export default class timePicker extends EventEmitter {
    ...
    _init() {
      ...
      this.start = utils.newDate(this.options.startTime, this.format, 'HH:mm') || dateFns.addHours(dateFns.startOfToday(), 8);
        this.end   = this.options.isRange ? utils.newDate(this.options.endTime, this.format, 'HH:mm') : dateFns.addHours(dateFns.startOfToday(), 17);
